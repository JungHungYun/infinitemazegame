...
const ABILITY_DEFS = [
    ...
    },
    {
        id: 'lethal_missile',
        name: '치명타',
        desc: '미사일로 추격자에게 대미지를 줄 수 있습니다. 추적자는 미사일 기본 공격력의 5배에 해당하는 체력을 가지며, 5번 맞으면 처치됩니다. 처치된 추격자는 다음 청크(맵)로 이동할 때 무작위 위치에서 부활합니다. 추격자로부터 안전하게 도망칠 시간을 벌 수 있는 강력한 능력입니다.',
        rarity: 'LEGENDARY',
        cost: 30,
